...
if __name__ == "__main__":
    ...
    # executable = os.path.join(deepsdf_dir, "bin/PreprocessMesh")
    executable = os.path.join(deepsdf_dir, "bin/PreprocessMeshMy")
    subdir = ws.sdf_samples_subdir
    extension = ".npz"
        ...
        for instance_dir in instance_dirs:
            ...
            try:
                ...
                for mesh_filename in mesh_filenames:
                    ...
                    # print("split", mesh_filename.split("/")[-1])
                    mesh_num = os.path.splitext(mesh_filename.split("/")[-1])[0]
                    
                    # print("target_instance_dir = ", target_instance_dir)
                    # print("mesh_num", mesh_num)
                    ...
                    # print("[mesh] ", os.path.join(shape_dir, mesh_filename))
                    # print("[proc] ", processed_filepath)
