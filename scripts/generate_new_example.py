...
source_path = f"/media/lj/TOSHIBA/dataset/ShapeNet/ShapeNetCore.v2"
limit_num = 50

synset_number = catogory_synset_dict[target_catogory]
cato_path = osp.join(source_path, synset_number)
...
json_data['DataSource'] = "/media/lj/TOSHIBA/dataset/ShapeNet/data"
